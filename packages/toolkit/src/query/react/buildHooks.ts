...
export interface InfiniteQueryHooks<
...
export type UseInfiniteQuery<D extends InfiniteQueryDefinition<any, any, any, any>> = <
...
export type UseInfiniteQueryState<D extends InfiniteQueryDefinition<any, any, any, any>> = <
  R extends Record<string, any> = UseInfiniteQueryStateDefaultResult<D>,
>(
  arg: QueryArgFrom<D> | SkipToken,
...
type UseInfiniteQueryStateBaseResult<D extends InfiniteQueryDefinition<any, any, any, any>> =
  QuerySubState<D> & {
  /**
   * Where `data` tries to hold data as much as possible, also re-using
   * data from the last arguments passed into the hook, this property
  ...
  fetchNextPage: (
  ) => Promise<UseInfiniteQueryStateResult<D, D>>
  fetchPreviousPage: (
  ) => Promise<UseInfiniteQueryStateResult<D, D>>
}

type UseInfiniteQueryStateDefaultResult<D extends InfiniteQueryDefinition<any, any, any, any>> =
  TSHelpersId<
    | TSHelpersOverride<
    Extract<
  ...
  >
    ...
    Pick<UseInfiniteQueryStateBaseResult<D>, 'data' | 'fulfilledTimeStamp'>
  >)
    | ({
    isSuccess: true
    isFetching: false
