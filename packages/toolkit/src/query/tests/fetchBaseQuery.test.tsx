...
describe('fetchBaseQuery', () => {
  ...
  describe('arg.params', () => {
    it('should not serialize missing params', async () => {
      ...
      expect((request as any).url).toEqual(`${baseUrl}/echo`)
    })
    ...
    it('should serialize numeric and boolean params', async () => {
      ...
      expect((request as any).url).toEqual(`${baseUrl}/echo?a=1&b=true`)
    })
    ...
    it('should merge params into existing url querystring', async () => {
      ...
      expect((request as any).url).toEqual(
        `${baseUrl}/echo?banana=pudding&a=1&b=true`,
      )
    })
    ...
    it('should accept a URLSearchParams instance', async () => {
      ...
      expect((request as any).url).toEqual(`${baseUrl}/echo?apple=fruit`)
    })
    ...
    it('should strip undefined values from the end params', async () => {
      ...
      expect((request as any).url).toEqual(
        `${baseUrl}/echo?apple=fruit&randy=null`,
      )
    })
    ...
    it('should supports a custom isJsonContentType function', async () => {
      ...
      expect((request as any).body).toMatchObject(testBody)
    })
  })
  ...
  describe('arg.headers and prepareHeaders', () => {
    test('uses the default headers set in prepareHeaders', async () => {
      ...
      expect((request as any).headers.fake).toBe(defaultHeaders.fake)
      expect((request as any).headers['delete']).toBe(defaultHeaders['delete'])
      expect((request as any).headers['delete2']).toBe(
        defaultHeaders['delete2'],
      )
    })
    ...
    test('adds endpoint-level headers to the defaults', async () => {
      ...
      expect((request as any).headers.authorization).toBe('Bearer banana')
      expect((request as any).headers.fake).toBe(defaultHeaders.fake)
      expect((request as any).headers['delete']).toBe(defaultHeaders['delete'])
      expect((request as any).headers['delete2']).toBe(
        defaultHeaders['delete2'],
    ...
    test('it does not set application/json when content-type is set', async () => {
      ...
      expect((request as any).headers['authorization']).toBe('Bearer banana')
      expect((request as any).headers['content-type']).toBe(
        'custom-content-type',
      )
      expect((request as any).headers.fake).toBe(defaultHeaders.fake)
      expect((request as any).headers['delete']).toBe(defaultHeaders['delete'])
    ...
    test('respects the headers from an endpoint over the base headers', async () => {
      ...
      expect((request as any).headers.fake).toBe(fake)
      expect((request as any).headers['delete']).toBeUndefined()
      expect((request as any).headers['delete2']).toBeUndefined()
    })
    ...
    test('prepareHeaders can return undefined', async () => {
      ...
      expect((request as any).headers.authorization).toBe(`Bearer ${token}`)
    })
  ...
  test('lets a header be undefined', async () => {
    ...
    expect((request as any).headers.fake).toBe(defaultHeaders.fake)
    expect((request as any).headers['delete']).toBe(defaultHeaders['delete'])
    expect((request as any).headers['delete2']).toBe(defaultHeaders['delete2'])
  })
  ...
  test('allows for possibly undefined header key/values', async () => {
    ...
    expect((request as any).headers.banana).toBe('1')
    expect((request as any).headers.fake).toBe(defaultHeaders.fake)
    expect((request as any).headers['delete']).toBe(defaultHeaders['delete'])
    expect((request as any).headers['delete2']).toBe(defaultHeaders['delete2'])
  })
  ...
  test('strips undefined values from the headers', async () => {
    ...
    expect((request as any).headers.banana).toBeUndefined()
    expect((request as any).headers.fake).toBe(defaultHeaders.fake)
    expect((request as any).headers['delete']).toBe(defaultHeaders['delete'])
    expect((request as any).headers['delete2']).toBe(defaultHeaders['delete2'])
  })
