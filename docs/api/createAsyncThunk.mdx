...
The options object gives you even more control over the async thunk internals. For example, you may customize how are requestIds generated by overriding the idGenerator option.
