...
It will return a type guard function that returns `true` if at least one of the provided functions match.
...
import {
  ...
  isInteresting,
  Data
} from '@matchers-virtual-repo' // This is a fake pkg that provides the types shown above
...
import { request, Data, isSpecial, isInteresting } from '@matchers-virtual-repo' // This is a fake pkg that provides the types shown above
