...
### Details on the builder methods

### `builder.addCase`

[summary,remarks,params,examples](docblock://mapBuilders.ts?token=ActionReducerMapBuilder.addCase)

### `builder.addMatcher`

[summary,remarks,params,examples](docblock://mapBuilders.ts?token=ActionReducerMapBuilder.addMatcher)
