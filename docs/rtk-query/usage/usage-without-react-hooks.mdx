...
RTK Query itself is library-agnostic, but includes a version of [`createApi`](../api/createApi.mdx) designed specifically for use with React which [automatically generates React hooks](../api/created-api/hooks.mdx).
...
<iframe
  src="https://codesandbox.io/embed/rtk-query-cache-lifetime-subscription-class-component-example-38mgd?fontsize=12&hidenavigation=1&module=%2Fsrc%2Fcomponents%2FUsersList.tsx&theme=dark&runonclick=1"
  style={{
    width: '100%',
    height: '800px',
    border: 0,
